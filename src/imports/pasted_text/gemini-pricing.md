...
Output price	Not available	$3 (text and thinking)
$60.00 (images)
...
Gemini 2.0 Flash
gemini-2.0-flash
Warning: Gemini 2.0 Flash is deprecated and will be shut down June 1, 2026. Migrate to a newer model to avoid service disruption.
Standard
Batch
Free Tier	Paid Tier, per 1M tokens in USD
...
Image generation pricing	Not available (shut down)	Not available (shut down)
...
gemini-2.0-flash-lite
Warning: Gemini 2.0 Flash-Lite is deprecated and will be shut down June 1, 2026. Migrate to a newer model to avoid service disruption.
Standard
Batch
Free Tier	Paid Tier, per 1M tokens in USD
...
Veo 3.1 Standard video with audio price (default)	Not available	$0.40 (720p and 1080p)
$0.60 (4k)
Veo 3.1 Fast video with audio price (default)	Not available	$0.15 (720p and 1080p)
$0.35 (4k)
Used to improve our products	Yes	No
...
Free Tier	Paid Tier, per 1M tokens in USD
Google Search	500 RPD free (limit shared for Flash and Flash-Lite).
Not available for Pro.	Gemini 2.5 models:
...
File search	Free of charge	Charged for embeddings at $0.15 / 1M tokens.
...
Model	Tools
Gemini Deep Research Agent	All model inference is charged at standard Gemini 3 Pro list rates, including input, output, and intermediate input / reasoning tokens generated during agentic loops.	Tool usage fees apply per existing pricing structure, maintaining standard distinctions for Search Grounding (retrieved tokens excluded) versus Url_context / File Search (retrieved tokens included in all other tools).
